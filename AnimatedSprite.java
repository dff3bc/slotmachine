...
public class AnimatedSprite extends Sprite {
    ...
    public void loadSpriteImage(String name) {
        animimage = Toolkit.getDefaultToolkit().getImage("src/" + name);
        ...
        super.setSpriteImage(tempImage);
    ...
    public void draw() {
        ...
        tempSurface.drawImage(animimage, 0, 0, this.getFrameWidth() - 1, this.getFrameHeight() - 1,
                this.getFrameX(), this.getFrameY(), this.getFrameX() + this.getFrameWidth(), this.getFrameY() + this.getFrameHeight(), Main.getInstance());
